...
let g:pdv_cfg_Author = "Harold Kim"
let g:pdv_cfg_Copyright = "pokoot.com"
let g:pdv_cfg_License = "http://pokoot.com/license.txt"
...
func! PhpDocFunc()
    ...
    " COMMENTED OUT BY KIM : NEXT 3 LINES
    "if l:scope != ""
    "	exe l:txtBOL . g:pdv_cfg_Commentn . "@access " . l:scope . g:pdv_cfg_EOL
    "endif
